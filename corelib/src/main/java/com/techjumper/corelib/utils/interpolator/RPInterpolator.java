package com.techjumper.corelib.utils.interpolator;

import android.view.animation.Interpolator;

/**
 * This interpolator use Rebert Penner's Easing Functions.
 * @see <a href="http://robertpenner.com/easing/">http://robertpenner.com/easing/</a>
 */
public class RPInterpolator implements Interpolator {

    private Easing mEasing;

    public RPInterpolator() {
        mEasing = Easing.LINEAR;
    }

    public RPInterpolator(Easing easing) {
        mEasing = easing;
    }
